...
# GET untuk melihat semua itinerary yang dimiliki user yang login
@router.get("/")
def get_itinerary(
...
def export_itinerary_pdf(
    ...
    if not items:
        raise HTTPException(status_code=404, detail=f"Tidak ada tempat pada hari {hari} di itinerary")
